  ...
  return (
    <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto border-t border-navy/5 bg-alabaster/30">
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div className="absolute left-9.75 md:left-1/2 top-0 bottom-0 w-px bg-navy/10 transform md:-translate-x-1/2" />
              ...
              >
                ...
                <div className="absolute left-0 md:left-1/2 top-0 transform md:-translate-x-1/2 flex items-center justify-center z-10">
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="w-20 h-20 rounded-full border border-navy/10 bg-alabaster flex flex-col items-center justify-center shadow-lg shadow-navy/5"
                  >
                ...
                <div className={`w-full md:w-1/2 pl-24 md:pl-0 ${
                  ...
                  <motion.div
                    ...
                    className="glass-panel rounded-4xl p-6 md:p-8 hover:border-coral/25 transition-colors shadow-sm"
                  >
