...
@font-face {
  ...
  src: url("https://assets.stablemoney.in/fonts/CircularStd-Book.woff") format("woff");
  font-weight: 400;
}
@font-face {
  font-family: "RecklessNeue";
  src: url("https://assets.stablemoney.in/fonts/RecklessNeue-Book.woff2") format("woff2");
  font-weight: 400;
}
@font-face {
  font-family: "DentonTest";
  src: url("https://assets.stablemoney.in/fonts/Denton-Test-Regular-400.otf") format("opentype");
  font-weight: 400;
}
@font-face {
  font-family: "Denton";
  src: url("https://assets.stablemoney.in/fonts/denton_700.otf") format("opentype");
  font-weight: 700;
}
@font-face {
  font-family: "Copperplate";
  src: url("https://assets.stablemoney.in/fonts/Copperplate.woff") format("woff2");
  font-weight: 400;
}
```
